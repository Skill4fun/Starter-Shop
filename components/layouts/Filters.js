...
const Filters = () => {
  ...
  function handleCheck(checkBoxType, checkBoxValue) {
    if (typeof window !== "undefined") {
      queryParams = new URLSearchParams(window.location.search);
    }
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Electronics"
                className="h-4 w-4"
                defaultChecked={handleCheck("category", "Electronics")}
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Laptops"
                className="h-4 w-4"
                defaultChecked={handleCheck("category", "Laptops")}
                onClick={(e) => handleClick(e.target)}
              />
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Toys"
                className="h-4 w-4"
                defaultChecked={handleCheck("category", "Toys")}
                onClick={(e) => handleClick(e.target)}
              />
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Office"
                className="h-4 w-4"
                defaultChecked={handleCheck("category", "Office")}
                onClick={(e) => handleClick(e.target)}
              />
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Beauty"
                className="h-4 w-4"
                defaultChecked={handleCheck("category", "Beauty")}
                onClick={(e) => handleClick(e.target)}
              />
            ...
            {[5, 4, 3, 2, 1].map((rating) => (
              <label key={rating} className="flex items-center">
                <input
                  ...
                  value={rating}
                  className="h-4 w-4"
                  defaultChecked={handleCheck("ratings", `${rating}`)}
                  onClick={(e) => handleClick(e.target)}
                />
